...
class NameForm extends React.Component {
  ...
  render(){
    return (<form action="/api/"  id="searchcontrols" method="post" name="searchcontrols" onSubmit={this.handleSubmit} >
    <label for="search">Search</label>
    <input type="text"  id="search" value={this.state.value} name="search"  onChange={this.handleChange}/>
    <input type="submit"  id="searchSubmit"  name="submitSearch" />
    ...
    { val.name && <span class="NameTitle" id={'name'+ val.id}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  { val.name}</span>}
    <div class="metadataContainer">
     <div class="metaDataOne">
     <div class="altNameContainer">
    { val.name && <span class="NameTitle" id={'name_'+ val.id}>  {val.name}</span>}
...
export const Search = () => {
  const [initialState, setIntialState] = useState([])
    return (
    <form action="/api/"  id="searchcontrols" method="post" name="searchcontrols" onSubmit={document.getElementById("searchcontrols").onSubmit} >
    <label for="search">Search</label>
    <input type="text"  id="search" value={new NameForm().state.value} name="search"  onChange={document.getElementById("searchcontrols").onChange}/>
    <input type="submit"  id="searchSubmit"  name="submitSearch" />
    <div id="container">
    {new NameForm().state && new NameForm().state.map(val => 
    <div class="resultContainer">
    <div class="nameContainer">
    <span class="infoContainer">
    { val.name && <span class="NameTitle" id={'name'+ val.id}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  { val.name}</span>}
